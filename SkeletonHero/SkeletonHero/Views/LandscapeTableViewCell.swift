...
class LandscapeTableViewCell: UITableViewCell {
    static let identifier = "LandscapeTableViewCell"
    ...
    func configure(landscape: LandscapeModel) {
        landscapeTitle.text = landscape.title
        landscapePlace.text = landscape.place
        landscapeImage.image = UIImage(named: landscape.image)
        
        // Setup Hero
        landscapeImage.hero.id = landscape.id.uuidString
        hero.isEnabled = true
    }
}
